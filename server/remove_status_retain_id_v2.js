...
async function applyFix() {
    try {
        ...
        try {
            console.log('Dropping upsert_airline routines...');

            // Explicitly drop potential procedures AND functions
            // We need to be aggressive here because of the procedure vs function conflict
            ...
            // Drop other overloads just in case
